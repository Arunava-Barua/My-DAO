...
const Proposal = () => {
  ...
  async function castVote(upDown) {
    let options = {
      contractAddress: "0x59E7f82cFb2E4a70905d09EfDEaC887445A0A72f",
    ...
    <>
      <div className="contentProposal">
        <div className="proposal">
          ...
          <div>{proposalDetails && proposalDetails.description}</div>

          <div className="proposalOverview">
            <Tag color={proposalDetails.color} text={proposalDetails.text} />
            <div className="proposer">
              <span>Proposed By </span>
              <Tooltip content={proposalDetails && proposalDetails.proposer}>
                <Blockie seed={proposalDetails && proposalDetails.proposer} />
              </Tooltip>
            </div>
          </div>
        </div>
